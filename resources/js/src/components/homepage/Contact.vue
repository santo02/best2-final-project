                    ...
                    <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">1500886<br></p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">cs@investree.id<br></p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">AIA Central Lantai 21, Jalan Jend. Sudirman Kav. 48A, RT05/RW04, Karet Semanggi, Jakarta Selatan, Indonesia 12930</p>
                            </div>
                        </div>
                    </div>
                </div>
